...
module snntorch_model #(
    ...
    wire signed [2*DATA_WIDTH-1:0] I_decay_mult;
    ...
    wire signed [2*DATA_WIDTH-1:0] V_decay_mult;
    ...
    // Internal intermediate wires for IF model
    wire signed [2*DATA_WIDTH-1:0] V_leaky_mult = V_decay_mult;
    ...
    assign ready = ready_I_t | ready_v_mem;
